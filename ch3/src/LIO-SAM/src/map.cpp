...
//TODO保存关键帧位姿
string path = "/home/zhw/Downloads/LIO-SAM2/pose.txt";
fstream file;
...
public:
    ...
    void visualizeGlobalMapThread()
    {
        ...
        pcl::io::savePCDFileASCII(savePCDDirectory + "sharp_cloud_map.pcd", *globalCornerCloudDS);
        // down-sample and save surf cloud
        downSizeFilterSurf.setInputCloud(globalSurfCloud);
        downSizeFilterSurf.filter(*globalSurfCloudDS);
        pcl::io::savePCDFileASCII(savePCDDirectory + "flat_cloud_map.pcd", *globalSurfCloudDS);
